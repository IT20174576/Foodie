...
<div class="container" style="margin-top:98px">
    <center>
    <h1><b>ManagerList</b></h1>
    </center>
    <div class="row">
        
        <div class="col-lg-5">
            <button class="btn btn-primary float-right" data-toggle="modal" data-target="#newUser" style = "position:relative; left:760px;"><i class="fa fa-plus"></i> Add Manager</button>
            <!-- <button class="btn btn-primary float-left" data-toggle="modal" data-target="#generatereport" style = "background-color: green;"><i class="fa fa-book"></i>PDF</button> -->
            <a href='partials/userReport.php' class="btn btn-info"><span>Print Report</span></a>
           <a asp-action="ManagerList" class="btn btn-outline-success" style = "position:relative; right:250px;">ManagerList</a>
        </div>

        <!-- <div class="col-lg-4">
            <div class="input-group">
                <input type="text" name="search" class="form-control" placeholder="Search By Name" id="searchinput" style = "position:relative; right:80px;">
                <div class="input-group-prepend">
                    // <span class="input-group-text bg-dark" style = "position:relative; right:80px;"><i class="fa fa-search text-light" ></i></span>
                    <button class="btn btn-primary float-right" style = "background-color: green; position:relative; right:80px;">Search</button>
                </div>
            </div>
        </div> -->
                        ...
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                elseif($userType == 1) 
                                    $userType = "Admin";
                                elseif($userType == 2) 
                                    $userType = "Food Manager";
                                else
                                    $userType = "Order Manager";
        ...
        <form action="partials/_userManage.php" method="post">
              ...
              <div class="form-group row my-0">
                    ...
                    <div class="form-group col-md-6 my-0">
                        ...
                        <option value="0">Customer Manager</option>
                        <option value="1">Admin</option>
                        <option value="2">Food Manager</option>
              ...
              <a class="btn btn-flat btn-default" href="?page=userManage">Cancel</a>
            </form>
      </div>
    </div>
  </div>
        ...
        <div class="modal-body">
            ...
            <form action="partials/_userManage.php" method="post">
                ...
                <div class="form-group row my-0">
                    ...
                    <div class="form-group col-md-6 my-0">
                        <b><label for="userType">Type:</label></b>
                        <select name="userType" id="userTy+pe" class="custom-select browser-default" required>
                        <?php 
                            if($userType == 1) {
                        ?>
                            <option value="0">Customer Manager</option>
                            ...
                            <option value="2">Food Manager</option>
                            <option value="3">Oder Manager</option>
                        ...
                        ?>
                            <option value="0">Customer Manager</option>
                            <option value="1">Admin</option>
                            <option value="2" selected>Food Manager</option>
                            <option value="3">Oder Manager</option>
                        <?php
                            } 
                            elseif ($userType == 3) { 
                        ?>
                            <option value="0" selected>Customer Manager</option>
                            <option value="1">Admin</option>
                            <option value="2">Food Manager</option>
                            <option value="3"  selected>Oder Manager</option>
                        <?php
                            } 
                            else {
                        ?>
