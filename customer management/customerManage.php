...
<center>
    <h1><b>Customer care manage</b></h1>
    </center>
	
	<div class="row">
        <div class="col-lg-12">
            <button class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#newUser"><i class="fa fa-plus"></i> New Customer</button>
        </div>
	</div>
		...
		<div class="card col-lg-12">
			<div class="card-body">
				...
				<table class="table-striped table-bordered col-md-12 text-center">
                    ...
                    <div>
                   			 <a href="#" onclick="window.print()" class="btn btn-primary float- btn-sm"><span>Print Report</span></a>
                    		</div>
                        <tr>
                            <th>CustomerId</th>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            ...
                                            if($Id == 1) {
                                                ...
                                                echo '<form action="partials/_customerManage.php" method="POST">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="newUser">Create New Customer</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="partials/_customerManage.php" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                <div class="form-group col-md-8">
                    <form action="partials/_customerManage.php" method="post" enctype="multipart/form-data">
