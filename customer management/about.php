          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Foodie</span></h2>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Foodie</strong></h3>
            <h3><strong>The Worldwide Leader in Foodie</strong></h3>
            <p class="font-italic">
          </div>
