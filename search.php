...
<body>
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            $query = $_GET["search"];
            $sql = "SELECT * FROM `product` WHERE MATCH(Name, Desc) against('$query')"; 
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="img/product-'.$pId. '.jpg" class="card-img-top" alt="image for this product" width="249px" height="270px">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">';
                                if($loggedin){
                                    $quaSql = "SELECT `itemQuantity` FROM `viewcart` WHERE Id = '$Id' AND `userId`='$userId'";
                                ...
                                echo '</form>
                                <a href="viewProduct.php?pizzaid=' . $pId . '"><button class="btn btn-primary">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
