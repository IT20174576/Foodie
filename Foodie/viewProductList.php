...
<body>
    ...
    <div class="container my-3" id="cont">
        ...
        <?php
            $id = $_GET['catid'];
            $sql = "SELECT * FROM `product` WHERE CategorieId = $id";
            $result = mysqli_query($conn, $sql);
            $noResult = true;
            while($row = mysqli_fetch_assoc($result)){
                $noResult = false;
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                if($loggedin){
                                    $quaSql = "SELECT `itemQuantity` FROM `viewcart` WHERE Id = '$pId' AND `userId`='$userId'";
                            ...
                            echo '</form>                            
                                <a href="viewProduct.php?pizzaid=' . $pId . '" class="mx-2"><button class="btn btn-primary">Quick View</button></a> 
                                </div>
                            </div>
                        </div>
                    </div>';
