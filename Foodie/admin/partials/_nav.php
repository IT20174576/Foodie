    <header class="header" id="header">
       ...
       <!--  <div class="header__img">
            <img src="assetsForSideBar/img/img.jpg" alt="">
        </div> -->
    </header>
        ...
        <nav class="nav">
            <div>
                <a href="index.php" class="nav__logo">
                    ...
                    <span class="nav__logo-name">Foodie</span>
                </a>
                ...
                <div class="nav__list">
                    ...
                    <a href="index.php?page=customerManage" class="nav__link nav-customerManage">
                      <i class='bx bx-user nav__customericon' ></i>
